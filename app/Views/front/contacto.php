<section class="container-fluid d-flex justify-content-center">
    <div class="row d-flex justify-content-center">
        <div class="text-center">
            <img src="<?php echo base_url('assets/img/chronos_logo.png');?>" class="img-fluid" alt="Logo Chronos Luxury Watches">
            <h1>Contacta a Chronos Luxury Watches</h1>
            <p>Razón social: <em>Chronos Luxury Watches S.A.</em></p>
            <p>Domicilio legal: <em>Avenida del Tiempo 888, Corrientes Capital, Argentina</em></p>
            <p>Teléfonos de contacto:</p>

            <li>Teléfono celular: <em>3795123456</em></li>
            <li>Teléfono fijo: <em>3794432100</em></li>
        </div>
        ...
        <div class="text-center">
            ...
            <ul class="nav flex-column">
                ...
                <p>
                    <a href="<?php echo base_url('sitio_en_construccion');?>" class="text-decoration-none">
                        Síguenos en Twitter <img class="img-fluid" src="assets/img/twitter.png" style="color:#00acee"
